            ...
            <div className="relative overflow-hidden">
                <div className="flex">
                    <div className="flex items-start flex-1">
                        <h5>
                            <span className="text-gray-800 text-[20px] font-bold">DANH SÁCH SẢN PHẨM ({data?.length})</span>
                        </h5>
                    </div>
                                                ...
                                                <div className="flex items-center">
                                                    {
                                                        item?.color?.map((color: any, index: any) => {
                                                            return (
                                                                <div key={index} className={`border border-gray-500 inline-block w-4 h-4 mr-2 ${HELPER.renderColor(color)} rounded-full`}></div>
                                                            )
                                                        })
                                                    }
                                                </div>
