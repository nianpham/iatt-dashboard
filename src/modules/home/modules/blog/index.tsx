                ...
                <div className="overflow-x-auto mt-4">
                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead className="text-md text-gray-700 uppercase bg-gray-50 border dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th scope="col" className="w-64 px-4 py-3">TIÊU ĐỀ</th>
                                <th scope="col" className="w-32 px-4 py-3">TAG</th>
                                <th scope="col" className="w-80 px-4 py-3">NỘI DUNG</th>
                                <th scope="col" className="w-32 px-4 py-3">TÁC GIẢ</th>
                                <th scope="col" className="w-24 px-4 py-3">NGÀY</th>
